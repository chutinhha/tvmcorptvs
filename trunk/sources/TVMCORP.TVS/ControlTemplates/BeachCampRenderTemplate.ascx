...
<%@ Register TagPrefix="uc" TagName="BeachCampNewEventControl" Src="~/_controltemplates/TVMCORP.TVS/BeachCampNewEvent.ascx" %>
<%@ Register TagPrefix="uc" TagName="BeachCampEditEventControl" Src="~/_controltemplates/TVMCORP.TVS/BeachCampEditEvent.ascx" %>
<%@ Register TagPrefix="uc" TagName="BeachCampDispEventControl" Src="~/_controltemplates/TVMCORP.TVS/BeachCampDispEvent.ascx" %>
