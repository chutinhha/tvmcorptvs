...
namespace TVMCORP.TVS.CustomFields
{
    public class LookupFieldWithPickerPropertyBag
    {
        ...
        public LookupFieldWithPickerPropertyBag(Guid webId, Guid listId, Guid fieldId, List<string> searchFields, int maxSearchResults, int entityEditorRows, string query)
        {
            this.ListId = listId;
            this.FieldId = fieldId;
            this.SearchFields = searchFields;
        ...
        {
            return ListId.ToString() + ";" + FieldId.ToString() + ";" + _searchFields + ";" + MaxSearchResults + ";" + EntityEditorRows + ";" + WebId.ToString() + ";" + FilterQuery;
        }
    }
}
