...
namespace TVMCORP.TVS.CustomFields
{
    public class LookupFieldWithPickerControl : BaseFieldControl
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            this.lookupEditor.CustomProperty = new LookupFieldWithPickerPropertyBag(lookupFieldPicker.LookupWebId, lookupList.ID, lookupField.Id, lookupFieldPicker.SearchableFields, lookupFieldPicker.MaxSearchResults, lookupFieldPicker.EntityEditorRows).ToString();
        ...
        protected string ParseDefaultValue(object value)
        {
            ...
            else
            {
                ...
                {
                    strValue = this.Context.Request.QueryString[Field.InternalName];
                }
                else
                {
