...
namespace TVMCORP.TVS.CustomFields
{
    public class LookupFieldWithPicker : SPFieldLookup
    {
        ...
        private const string CustomFilterPropName = "CustomFilter";
        ...
        private void EnsureCustomPropertiesFixIfNeeded()
        {
            ...
            {                
                ...
                AdditionalFilter = cachedInstance.AdditionalFilter;
        ...
        public void UpgradeIfNecessary()
        {
            if (CurrentInstanceVersion < Version)
            {
                ...
                RemoveAttribute(xField, CustomFilterPropName);
        ...
        public string AdditionalFilter { 
            get {
                if (!string.IsNullOrEmpty(_filter)) return _filter;

                _filter = (string)this.GetCustomProperty(CustomFilterPropName);
                return _filter;
                }
            
            set {
                _filter = value;
                SetCustomProperty(CustomFilterPropName, value);    
            }
