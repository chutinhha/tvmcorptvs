...
namespace TVMCORP.TVS.BeachCampWorkflow
{
    public sealed partial class BeachCampWorkflow : SequentialWorkflowActivity
    {
        ...
        public static DependencyProperty publishItemActivity1_CommentTextProperty = DependencyProperty.Register("publishItemActivity1_CommentText", typeof(System.String), typeof(TVMCORP.TVS.BeachCampWorkflow.BeachCampWorkflow));
        ...
        public String publishItemActivity1_CommentText
        {
            get
            {
                return ((string)(base.GetValue(TVMCORP.TVS.BeachCampWorkflow.BeachCampWorkflow.publishItemActivity1_CommentTextProperty)));
            }
            set
            {
                base.SetValue(TVMCORP.TVS.BeachCampWorkflow.BeachCampWorkflow.publishItemActivity1_CommentTextProperty, value);
            }
        }
