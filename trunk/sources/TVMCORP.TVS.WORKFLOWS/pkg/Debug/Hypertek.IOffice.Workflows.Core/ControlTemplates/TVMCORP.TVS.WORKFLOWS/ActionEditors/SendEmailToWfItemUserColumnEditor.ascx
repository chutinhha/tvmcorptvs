...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SendEmailToWfItemUserColumnEditor.ascx.cs" Inherits="TVMCORP.TVS.WORKFLOWS.Controls.SendEmailToWfItemUserColumnEditor" %>
...
<TABLE border="0" width="95%" cellspacing="0" cellpadding="0" class="ms-formtable" >
	<wssuc:InputFormSection runat="server" Title="Send email to Workflow Item PersonOrGroup Column">
		<Template_Description>
			<SharePoint:EncodedLiteral ID="EncodedLiteral1" runat="server" text="This action will send an email to users in a column of workflow item." EncodeMethod='HtmlEncode'/>
		</Template_Description>
