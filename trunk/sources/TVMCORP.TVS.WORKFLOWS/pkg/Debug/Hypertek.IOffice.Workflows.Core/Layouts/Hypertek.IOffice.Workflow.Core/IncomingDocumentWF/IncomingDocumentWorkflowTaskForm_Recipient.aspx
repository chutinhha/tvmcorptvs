...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncomingDocumentWorkflowTaskForm_Recipient.aspx.cs" Inherits="Hypertek.IOffice.Workflow.Core.Layouts.Hypertek.IOffice.Workflow.Core.IncomingDocumentWorkflowTaskForm_Recipient" DynamicMasterPageFile="~masterurl/default.master" %>
                    ...
                    <tr>
                        <td>
                            <table border="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td class="ms-formlabel" valign="top" nowrap="true" width="25%">
                                        <%= OfficialDocumentResources.RecipientNote %>
                                    </td>
                                    <td width="75%" class="ms-formbody" valign="top">
                                        <asp:TextBox ID="txtRecipientNote" runat="server" TextMode="MultiLine" Rows="6" class="input_form"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
