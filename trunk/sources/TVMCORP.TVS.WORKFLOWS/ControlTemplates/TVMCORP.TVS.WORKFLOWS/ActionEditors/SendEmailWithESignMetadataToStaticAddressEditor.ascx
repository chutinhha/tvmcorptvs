...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SendEmailWithESignMetadataToStaticAddressEditor.ascx.cs" Inherits="TVMCORP.TVS.WORKFLOWS.Controls.SendEmailWithESignMetadataToStaticAddressEditor" %>
...
<TABLE border="0" width="95%" cellspacing="0" cellpadding="0" class="ms-formtable" >
	<wssuc:InputFormSection runat="server" Title="Send email with ESignMetadata to static addresses">
		<Template_Description>
			<SharePoint:EncodedLiteral ID="EncodedLiteral1" runat="server" text="This action will send an email to specified email addresses, the email template support to using ESign's metadata" EncodeMethod='HtmlEncode'/>
		</Template_Description>
