...
{
    public partial class SendEmailWithESignVariableToWfItemUserColumnEditor : ActionEditorControl
    {
       ...
       protected override void OnInit(EventArgs e)
        ...
        private void displayActionData()
        {
            ...
            SendEmailWithESignVariableToWfItemUserColumnSettings savedAction = (SendEmailWithESignVariableToWfItemUserColumnSettings)Action;
        ...
        public override TaskActionSettings GetAction()
        {
            ...
            return new SendEmailWithESignVariableToWfItemUserColumnSettings()
            {
