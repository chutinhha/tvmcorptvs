...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SendEmailWithESignMetadataToWfItemUserColumnEditor.ascx.cs" Inherits="TVMCORP.TVS.WORKFLOWS.Controls.SendEmailWithESignMetadataToWfItemUserColumnEditor" %>
...
<TABLE border="0" width="95%" cellspacing="0" cellpadding="0" class="ms-formtable" >
	<wssuc:InputFormSection runat="server" Title="Send email with ESignMetadata to workflow item user column">
		<Template_Description>
			<SharePoint:EncodedLiteral ID="EncodedLiteral1" runat="server" text="This action will send an email to users in a column of workflow item. Email template support to using ESign's metadata" EncodeMethod='HtmlEncode'/>
		</Template_Description>
