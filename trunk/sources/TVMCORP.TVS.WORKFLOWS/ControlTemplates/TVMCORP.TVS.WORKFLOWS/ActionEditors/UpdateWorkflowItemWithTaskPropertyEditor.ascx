...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateWorkflowItemWithTaskPropertyEditor.ascx.cs" Inherits="TVMCORP.TVS.WORKFLOWS.CONTROLTEMPLATES.TVMCORP.TVS.WORKFLOWS.UpdateWorkflowItemWithTaskPropertyEditor" %>
...
<TABLE border="0" width="95%" cellspacing="0" cellpadding="0" class="ms-formtable" >
	<wssuc:InputFormSection runat="server" Title="Update Item Property With Task Property">
