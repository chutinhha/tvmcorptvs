...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateWorkflowItemWithEsignVariablesEditor.ascx.cs" Inherits="TVMCORP.TVS.WORKFLOWS.CONTROLTEMPLATES.TVMCORP.TVS.WORKFLOWS.UpdateWorkflowItemWithEsignVariablesEditor" %>
...
<TABLE border="0" width="95%" cellspacing="0" cellpadding="0" class="ms-formtable" >
	<wssuc:InputFormSection runat="server" Title="Update workflow item with ESign Recipient Metadata">
		<Template_Description>
			<SharePoint:EncodedLiteral ID="EncodedLiteral1" runat="server" text="This action will update Workflow Item with returning ESign recipient's metadata." EncodeMethod='HtmlEncode'/>
		</Template_Description>
		<Template_InputFormControls>
			...
			<wssuc:InputFormControl runat="server" LabelText="Variable Name">
			    <Template_Control>
			        <asp:DropDownList ID="ddlMetadataProperty" runat="server" CssClass="ms-long" /> 
			         <wssawc:InputFormRequiredFieldValidator ID="ddlMetadataPropertyRequiredFieldValidator" 
				                                            ControlToValidate="ddlMetadataProperty"
					                                        Display="Dynamic" 
