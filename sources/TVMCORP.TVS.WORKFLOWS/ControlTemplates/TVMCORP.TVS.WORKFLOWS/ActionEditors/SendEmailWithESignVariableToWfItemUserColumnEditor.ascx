...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SendEmailWithESignVariableToWfItemUserColumnEditor.ascx.cs" Inherits="TVMCORP.TVS.WORKFLOWS.CONTROLTEMPLATES.TVMCORP.TVS.WORKFLOWS.SendEmailWithESignVariableToWfItemUserColumnEditor" %>
...
<TABLE border="0" width="95%" cellspacing="0" cellpadding="0" class="ms-formtable" >
	<wssuc:InputFormSection runat="server" Title="Send email with Esign Variables to workflow item user column">
		<Template_Description>
			<SharePoint:EncodedLiteral ID="EncodedLiteral1" runat="server" text="This action will send an email to users in a column of workflow item. Email template support to using ESign's variables" EncodeMethod='HtmlEncode'/>
		</Template_Description>
		<Template_InputFormControls>
			<wssuc:EmailTemplateSelector runat="server" id="TaskEmailTemplateSelector" ValidationGroup="SubmitValidate" />
			
			<wssuc:InputFormControl runat="server" LabelText="To users in column">
			<Template_Control>
