...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskEvent.aspx.cs" Inherits="TVMCORP.TVS.WORKFLOWS.Layouts.TaskEvent" DynamicMasterPageFile="~masterurl/default.master" EnableSessionState="True" %>
...
<%--<script type="text/javascript" src="/_LAYOUTS/TVMCORP.TVS.WORKFLOWS/jquery-1.5.1.min.js" ></script>--%>
<style type="text/css">
	#Buttons {
	display:none;
	}
