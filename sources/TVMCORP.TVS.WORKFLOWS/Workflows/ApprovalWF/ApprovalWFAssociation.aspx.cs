...
namespace TVMCORP.TVS.WORKFLOWS.Workflows
{
    public partial class ApprovalWFAssociation : LayoutsPageBase
    {
        ...
        protected ApprovalUC ApprovalUC
        {
            get { return ucApprovalUC as ApprovalUC; }
        }
        ...
        {
            string xmlserialized = SerializationHelper.SerializeToXml<ApprovalWFAssociationData>(ApprovalUC.AssociationForm);
        ...
        private void InitializeParams()
        {
            ...
            {
                ApprovalUC.FirstLoad = false;
                this.associationParams = (AssociationParams)ViewState["associationParams"];
            }
            //ApprovalUC.WorkflowAssociation = this.associationParams;

            ApprovalUC.ListID = this.associationParams.TargetListGuid;
        ...
        private void InitializeTaskListParams()
        {
            ...
            if (!string.IsNullOrEmpty(taskListParam))
            {
        ...
        private void InitializeHistoryListParams()
        {
            ...
            if (!string.IsNullOrEmpty(historyListParam))
            {
                if (this.associationParams.AssociationType == WorkflowAssociationType.SiteContentTypeAssociation)
                {
