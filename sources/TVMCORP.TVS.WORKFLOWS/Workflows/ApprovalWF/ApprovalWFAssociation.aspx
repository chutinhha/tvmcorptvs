...
<%@ Register TagPrefix="uc" TagName="ApprovalUC" Src="/_controltemplates/TVMCORP.TVS.WORKFLOWS.Core/ApprovalUC.ascx" %>

<%@ Page Language="C#" DynamicMasterPageFile="~masterurl/default.master" AutoEventWireup="true"
    Inherits="TVMCORP.TVS.WORKFLOWS.Core.Workflows.ApprovalWFAssociation" CodeBehind="ApprovalWFAssociation.aspx.cs" %>
