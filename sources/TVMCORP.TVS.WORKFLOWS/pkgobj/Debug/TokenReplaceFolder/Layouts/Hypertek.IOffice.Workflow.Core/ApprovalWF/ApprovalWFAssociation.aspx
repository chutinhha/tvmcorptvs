...
<%@ Register TagPrefix="uc" TagName="ApprovalUC" Src="/_controltemplates/Hypertek.IOffice.Workflow.Core/ApprovalUC.ascx" %>

<%@ Page Language="C#" DynamicMasterPageFile="~masterurl/default.master" AutoEventWireup="true"
    Inherits="Hypertek.IOffice.Workflow.Core.Workflows.ApprovalWFAssociation" CodeBehind="ApprovalWFAssociation.aspx.cs" %>
