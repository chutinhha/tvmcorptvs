...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncomingDocumentWorkflowTaskForm_FocalPointUnit.aspx.cs" Inherits="Hypertek.IOffice.Workflow.Core.Layouts.Hypertek.IOffice.Workflow.Core.IncomingDocumentWorkflowTaskForm_FocalPointUnit" DynamicMasterPageFile="~masterurl/default.master" %>
                    ...
                    <tr>
                        <td>
                            <table border="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td class="ms-formlabel" valign="top" nowrap="true" width="25%">
                                        <%= OfficialDocumentResources.FocalPointUnitNote %>
                                    </td>
                                    <td width="75%" class="ms-formbody" valign="top">
                                        <asp:TextBox ID="txtFocalPointUnitNote" runat="server" TextMode="MultiLine" Rows="6" class="input_form"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
