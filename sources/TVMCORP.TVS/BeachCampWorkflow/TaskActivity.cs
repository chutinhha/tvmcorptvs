...
namespace TVMCORP.TVS.BeachCampWorkflow
{
    public class TaskActivity : SequenceActivity
    {
        ...
        public static DependencyProperty CreateTask_TaskPropertiesProperty = DependencyProperty.Register("CreateTask_TaskProperties", typeof(Microsoft.SharePoint.Workflow.SPWorkflowTaskProperties), typeof(TVMCORP.TVS.BeachCampWorkflow.TaskActivity));
