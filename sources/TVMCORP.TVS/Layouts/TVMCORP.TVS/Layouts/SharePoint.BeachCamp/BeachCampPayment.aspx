...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BeachCampPayment.aspx.cs"
    Inherits="TVMCORP.TVS.Layouts.TVMCORP.TVS.BeachCampPayment"
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    <input id="btnToggleBCR" style="float: right; margin: 8px 10px 8px 0px;" type="button"
        value="Show/Hide Beach Camp Reservation" />
    ...
    <table class="tbl-main tbl-beachcamp-reservation" id="tblMain" runat="server">
        ...
        <tr class="tr-main" style="border: 1px solid black;">
            <td class="td-main">
                ...
                <br />
                    <asp:Label ID="lblApprovalError" Font-Bold="true" ForeColor="Red" Visible="false" runat="server" Text=""></asp:Label>
                <br />
                ...
                <br />
                <br />
                <asp:TextBox runat="server" TextMode="MultiLine" Enabled="false" Width="100%" Rows="15" ID="txtMessage" />
    ...
    <table class="tbl-main" width="100%" cellspacing="0" cellpadding="0">
        <tr class="tr-main">
            <td class="td-main">
                ...
                <br />
                <asp:RadioButton GroupName="BeachCamp" Checked="true" Font-Bold="true" Text="Unpaid."
                    runat="server" ID="radUnpaid" />
                <br />
                <asp:RadioButton GroupName="BeachCamp" ID="radPaid" Font-Bold="true" Text="Paid"
                    runat="server" />
                <br />
            </td>
        </tr>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" style="padding-top: 7px">
        <tr>
            <td width="100%" align="right">
                ...
                <asp:Button runat="server" ID="btnCancel" CssClass="ms-ButtonHeightWidth" Text="Cancel"
                    Enabled="true" OnClientClick="window.frameElement.commitPopup();return false;" />
            </td>
        </tr>
    </table>
</asp:Content>
